...
///其它代理方法照常使用，其中- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath也可以不写，建议在Cell中重写didSelectItem_mc处理点击事件
